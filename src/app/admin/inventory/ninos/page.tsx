...
const ninosProducts = [
  {
    ...
    price: "$27.99",
    image: "/images/productos/17.jpg",
    colors: ["blue", "red", "black"],
  },
  {
    id: 2,
    name: "Zapatilla Dinosaurio",
    price: "$24.99",
    image: "/images/productos/18.jpg",
    colors: ["green", "brown"],
  },
  {
    id: 3,
    name: "Zapatilla Cars",
    price: "$26.99",
    image: "/images/productos/19.jpg",
    colors: ["red", "yellow"],
  },
  {
    id: 4,
    name: "Zapatilla Fútbol",
    price: "$29.50",
    image: "/images/productos/20.jpg",
    colors: ["black", "white"],
  },
]

export default function NinosInventory() {
      ...
      <div className="bg-gray-600 py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-white">
            ...
            <span>/</span>
            <Link href="/admin/inventory/ninos" className="hover:text-gray-300">
              NIÑOS
            </Link>
            <span>/</span>
